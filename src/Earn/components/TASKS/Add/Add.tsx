    ...
    return (
        <div style={{ overflowY: 'auto', marginBottom: '6rem' }}>
            ...
            >
                ...
                <div style={{ marginBottom: "12px" }}>
                    <label style={{ display: "block", marginBottom: "4px", fontWeight: "bold" }}>Telegram Channel Link</label>
                    <input
                        type="text"
                        value={src}
                ...
                <button
                    ...
                    style={{ opacity: err ? '0.5' : '1', width: "70vw", padding: "0.6rem", backgroundColor: "rgb(42,54,73)", color: "#fff", fontSize: '1rem', border: "none", borderRadius: "0.3rem", marginTop: '0.3rem', cursor: "pointer" }}
                >
                    Create Task
