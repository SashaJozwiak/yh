export const langG = {
    ...
    ru: {
        'house': 'ДОМ',
        'floor': 'ЭТАЖ',
        1: "5 лет назад собирал эйрдропы, а теперь инвестирует в блокчейн-стартапы и хорошо зарабатывает.",
        ...
        4: "делает обзоры новых блокчейн-проектов и мероприятий. Любит своих подписчиков, публикует дорогую рекламу.",
        ...
        10: "один из крупнейших держателей активов в блокчейнах. Деньги для него — всего лишь инструмент.",
