...
export const ShowAddCards = ({ cards }) => {
    ...
    return (
        <div
            ...
            className={`${s.container} ${s.list} scrollable`}>
            <h3>You got it</h3>

            <div
                onClick={() => showGetCards()}
                style={{ padding: '0.2rem', position: 'fixed' }}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} width={30} style={{ position: 'fixed', right: '0.6rem' }} stroke="white">
