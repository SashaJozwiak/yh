...
export const BuyCardsUp = ({ setBuyCardsUp }) => {
    ...
    const [payOptions] = useState([{ amount: 10, price: 10 }, { amount: 100, price: 100 }, { amount: 500, price: 500 }, { amount: 1000, price: 1000 }, { amount: 5000, price: 5000 }, { amount: 10000, price: 10000 }, { amount: 15000, price: 15000 }])
