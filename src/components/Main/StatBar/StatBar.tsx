    ...
    return (
        <div className={s.statbar}>
            ...
            <button
                ...
                <h3>{balanceData.isHold /* && nav */ ? <ButtonTimer /> : <span className={rawAddress ? s.holdtexton : s.holdtext} style={{ color: rawAddress ? 'white' : 'grey' }}>🟢</span>} <span className={s.holdtext}></span> HOLD!</h3>
            </button>
        </div>
    )
}
